---
title: Using Ollama in OpenChat
image: https://github.com/openhub/open-chat/assets/28616219/bb5b3611-3aa8-4ec7-a6dc-f35a13b34d81
---

# Using Ollama in OpenChat

<Image
  alt={'Using Ollama in OpenChat'}
  borderless
  cover
  src={'https://github.com/openhub/open-chat/assets/28616219/a2a091b8-ac45-4679-b5e0-21d711e17fef'}
/>

Ollama is a powerful framework for running large language models (LLMs) locally, supporting various language models including Llama 2, Mistral, and more. Now, OpenChat supports integration with Ollama, meaning you can easily use the language models provided by Ollama to enhance your application within OpenChat.

This document will guide you on how to use Ollama in OpenChat:
...
Next, you can start conversing with the local LLM using OpenChat.
...
<Video
  height={524}
  inStep
  src="https://github.com/openhub/open-chat/assets/28616219/063788c8-9fef-4c6b-b837-96668ad6bc41"
/>

  <Callout type={'info'}>
    You can visit [Integrating with Ollama](/en/self-hosting/examples/ollama) to learn how to deploy
    OpenChat to meet the integration requirements with Ollama.
  </Callout>
</Steps>
...
<Image
  ...
  height={274}
  src={'https://github.com/openhub/open-chat/assets/28616219/da0db930-78ce-4262-b648-2b9e43c565c3'}
/>
