...
<Image
  alt={'Using Gemma in OpenChat'}
  cover
  src={'https://github.com/openhub/open-chat/assets/28616219/e636cb41-5b7f-4949-a236-1cc1633bd223'}
/>

[Gemma](https://blog.google/technology/developers/gemma-open-models/) is an open-source large language model (LLM) from Google, designed to provide a more general and flexible model for various natural language processing tasks. Now, with the integration of OpenChat and [Ollama](https://ollama.com/), you can easily use Google Gemma in OpenChat.

This document will guide you on how to use Google Gemma in OpenChat:
...
<Image
  ...
  height={629}
  inStep
  src={'https://github.com/openhub/open-chat/assets/28616219/c91d0c18-a21f-41f6-b5cc-94d29faeb797'}
  width={791}
/>
...
Now, you can start conversing with the local Gemma model using OpenChat.
