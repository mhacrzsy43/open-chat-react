...
[`@openhub/tts`](https://tts.openhub.com) is a high-quality TTS toolkit developed using the TS language, supporting usage in both server and browser environments.
...
<Callout type={'info'}>
  During the implementation of the TTS feature in OpenChat, we found that there was no good frontend
