...
OpenChat supports the configuration of external identity verification services for internal use within enterprises/organizations to centrally manage user authorization.
