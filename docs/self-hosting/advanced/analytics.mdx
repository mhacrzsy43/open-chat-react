...
To better help analyze the usage of OpenChat users, we have integrated several free/open-source data analytics services in OpenChat for collecting user usage data, which you can enable as needed.
