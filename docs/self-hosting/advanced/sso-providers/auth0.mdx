...
<Image
  ...
  inStep
  src="hhttps://github.com/CloudPassenger/open-chat/assets/30863298/1b405347-f4c3-4c55-82f6-47116f2210d0"
/>
...
<Image
  ...
  inStep
  src="https://github.com/CloudPassenger/open-chat/assets/30863298/75c92f85-3ad3-4473-a9c6-e667e28d428d"
/>
...
<Image
  ...
  inStep
  src="https://github.com/CloudPassenger/open-chat/assets/30863298/a1ed996b-95ef-4b7d-a50d-b4666eccfecb"
/>
...
<Image
  ...
  inStep
  src="https://github.com/CloudPassenger/open-chat/assets/30863298/575f46aa-f485-49bd-8b90-dbb1ce1a5c1b"
/>
...
Click on the "Users Management" in the left navigation bar to enter the user management interface, where you can create users for your organization to log in to OpenChat.
...
<Image
  alt="Add Users"
  inStep
  src="https://github.com/CloudPassenger/open-chat/assets/30863298/3b8127ab-dc4f-4ff9-a4cb-dec3ef0295cc"
/>

### Configure Environment Variables

When deploying OpenChat, you need to configure the following environment variables:

| Environment Variable | Type | Description |
| --- | --- | --- |
| `ENABLE_OAUTH_SSO` | Required | Enable single sign-on (SSO) for OpenChat. Set to `1` to enable single sign-on. |
...
<Callout>
  After successful deployment, users will be able to authenticate and use OpenChat using the users
  configured in Auth0.
</Callout>
...
<Image
  ...
  src="https://github.com/CloudPassenger/open-chat/assets/30863298/32650f4f-d0b0-4843-b26d-d35bad11d8a3"
/>
...
<Image
  ...
  src="https://github.com/CloudPassenger/open-chat/assets/30863298/7b6f6a6c-2686-49d8-9dbd-0516053f1efa"
/>

<Callout type={'warning'}>
  Configuring social login services by default allows anyone to authenticate, which may lead to
  OpenChat being abused by external users.
</Callout>
