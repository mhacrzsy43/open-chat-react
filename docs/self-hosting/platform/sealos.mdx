# Deploy OpenChat with SealOS

If you want to deploy OpenChat on SealOS, you can follow the steps below:
...
[deploy-link]: https://cloud.sealos.io/?openapp=system-template%3FtemplateName%3Dopen-chat
