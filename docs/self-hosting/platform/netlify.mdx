# Deploy OpenChat with Netlify

If you want to deploy OpenChat on Netlify, you can follow these steps:

## Deploy OpenChat with Netlify

<Steps>
  ### Fork the OpenChat Repository

Click the Fork button to fork the OpenChat repository to your GitHub account.
...
<Image
  ...
  height={362}
  inStep
  src={'https://github.com/openhub/open-chat/assets/28616219/31b999e5-2a74-45fc-935b-f036e72a684d'}
/>
...
<Image
  ...
  height={273}
  inStep
  src={'https://github.com/openhub/open-chat/assets/28616219/c9c58141-5ec6-43f1-8d97-0a84a04dcdba'}
/>

Next, select the OpenChat project:

{' '}

<Image
  alt={'Select the OpenChat github project'}
  height={228}
  inStep
  src={'https://github.com/openhub/open-chat/assets/28616219/6c3968a8-fbbb-4268-a587-edaced2d96af'}
/>
...
<Image
  alt={'Configure OpenChat site name'}
  height={712}
  inStep
  src={'https://github.com/openhub/open-chat/assets/28616219/f3885537-6d43-422f-b1b8-e70732401025'}
/>
...
<Image
  alt={'Add OpenChat site environment variables'}
  height={537}
  inStep
  src={'https://github.com/openhub/open-chat/assets/28616219/3b607482-4d99-455a-bc10-3090dd4fe3c5'}
/>
...
<Callout type={'tip'}>
  For a complete list of environment variables supported by OpenChat, please refer to the [📘
  Environment Variables](/en/self-hosting/environment-variables)
</Callout>

Afteradding the variables, finally click "Deploy open-chat" to enter the deployment phase
...
<Image
  ...
  height={600}
  inStep
  src={'https://github.com/openhub/open-chat/assets/28616219/c9f74ec4-ce63-4ce9-b9e2-34bda6fda10b'}
/>
...
<Image
  ...
  height={396}
  inStep
  src={'https://github.com/openhub/open-chat/assets/28616219/a7fd85d5-fd32-4756-814e-ff7ab7567fe1'}
/>

Upon entering the deployment details, you will see the following interface, indicating that your OpenChat is currently being deployed. Simply wait for the deployment to complete.

{' '}

<Image
  alt={'OpenChat deployment in progress'}
  height={325}
  inStep
  src={'https://github.com/openhub/open-chat/assets/28616219/1ed8b13d-046e-47c8-bd61-116ffdf5d01b'}
/>
...
<Image
  ...
  height={558}
  inStep
  src={'https://github.com/openhub/open-chat/assets/28616219/1c82d707-cb6f-4924-b246-a5235a919864'}
/>

### Deployment Successful, Start Using

If your Deploy Log in the interface looks like the following, it means your OpenChat has been successfully deployed.
...
<Image
  ...
  height={558}
  inStep
  src={'https://github.com/openhub/open-chat/assets/28616219/c1f945d1-f3e2-4100-b6bb-24d4cb13c438'}
/>

At this point, you can click on "Open production deploy" to access your OpenChat site.

  <Image alt={'Access Your OpenChat Site'} height={527} inStep src={'https://github.com/openhub/open-chat/assets/28616219/b04723eb-64ad-4028-a901-dc4e4ee2d0c1'} />
</Steps>
