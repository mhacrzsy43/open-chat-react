...
When deploying OpenChat, a rich set of environment variables related to model service providers is provided, allowing you to easily define the model service providers to be enabled in OpenChat.
...
- [Why is the return value blank after installing Docker, configuring environment variables?](https://github.com/openhub/open-chat/discussions/623)
- [Reasons for errors when using third-party interfaces](https://github.com/openhub/open-chat/discussions/734)
- [No response in chat after filling in the proxy server address](https://github.com/openhub/open-chat/discussions/1065)
...
You can find all current model names in [modelProviders](https://github.com/openhub/open-chat/tree/main/src/config/modelProviders).
