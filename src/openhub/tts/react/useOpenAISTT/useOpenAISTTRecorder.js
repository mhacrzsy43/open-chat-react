...
var _excluded = ["onBlobAvailable", "onTextChange", "onSuccess", "onError", "onFinished", "onStart", "onStop", "options"];
...
export var useOpenAISTTRecorder = function useOpenAISTTRecorder() {
  ...
  var _useAudioRecorder = useAudioRecorder(function (blobData) {
      setShouldFetch(true);
      onBlobAvailable === null || onBlobAvailable === void 0 || onBlobAvailable(blobData);
    }),
    start = _useAudioRecorder.start,
    stop = _useAudioRecorder.stop,
    blob = _useAudioRecorder.blob,
    url = _useAudioRecorder.url,
    isRecording = _useAudioRecorder.isRecording,
          ...
          return _regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                text = json.text;
                setText(text);
                onTextChange === null || onTextChange === void 0 || onTextChange(text);
                handleStop();
