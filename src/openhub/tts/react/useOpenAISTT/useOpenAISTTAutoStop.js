...
import { useSpeechRecognitionAutoStop } from "../useSpeechRecognition/useSpeechRecognitionAutoStop";
export var useOpenAISTTAutoStop = function useOpenAISTTAutoStop(locale) {
  ...
  var _useSpeechRecognition = useSpeechRecognitionAutoStop(locale, {
  ...
  var _useOpenAISTTCore = useOpenAISTTCore(_objectSpread({
      ...
      onSuccess: function () {
        var _onSuccess2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(data) {
          var _len2,
            rest,
            _key2,
            json,
          ...
          return _regeneratorRuntime.wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 4:
                ...
                handleStop();
                onFinished === null || onFinished === void 0 || onFinished.apply(void 0, [data].concat(rest));
              case 10:
              case "end":
