...
import { type MicrosoftSpeechAPI, type MicrosoftSpeechPayload } from "../../core/MicrosoftSpeechTTS";
import { type TTSOptions } from "../useTTS";
export interface MicrosoftSpeechOptions extends Pick<MicrosoftSpeechPayload, 'options'>, TTSOptions {
    api?: MicrosoftSpeechAPI;
    locale?: string;
}
export declare const useMicrosoftSpeech: (defaultText: string, init: MicrosoftSpeechOptions) => {
