...
import { OpenOpenRouterAI } from "./index";
...
let instance: OpenOpenRouterAI;

beforeEach(() => {
  instance = new OpenOpenRouterAI({ apiKey: "test" });
...
describe("OpenOpenRouterAI", () => {
  describe("init", () => {
    it("should correctly initialize with an API key", async () => {
      const instance = new OpenOpenRouterAI({ apiKey: "test_api_key" });
      expect(instance).toBeInstanceOf(OpenOpenRouterAI);
  ...
  describe("chat", () => {
    ...
    describe("OpenOpenRouterAI chat with callback and headers", () => {
