...
import { OpenMistralAI } from "./index";
...
let instance: OpenMistralAI;

beforeEach(() => {
  instance = new OpenMistralAI({ apiKey: "test" });
...
describe("OpenMistralAI", () => {
  describe("init", () => {
    it("should correctly initialize with an API key", async () => {
      const instance = new OpenMistralAI({ apiKey: "test_api_key" });
      expect(instance).toBeInstanceOf(OpenMistralAI);
  ...
  describe("chat", () => {
    ...
    describe("OpenMistralAI chat with callback and headers", () => {
