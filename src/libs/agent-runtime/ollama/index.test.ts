...
import { OpenOllamaAI } from "./index";
...
let instance: OpenOllamaAI;

beforeEach(() => {
  instance = new OpenOllamaAI({ apiKey: "test" });
...
describe("OpenOllamaAI", () => {
  describe("init", () => {
    it("should correctly initialize with an API key", async () => {
      const instance = new OpenOllamaAI({ apiKey: "test_api_key" });
      expect(instance).toBeInstanceOf(OpenOllamaAI);
  ...
  describe("chat", () => {
    ...
    describe("OpenOllamaAI chat with callback and headers", () => {
