...
import { OpenPerplexityAI } from "./index";
...
let instance: OpenPerplexityAI;

beforeEach(() => {
  instance = new OpenPerplexityAI({ apiKey: "test" });
...
describe("OpenPerplexityAI", () => {
  describe("init", () => {
    it("should correctly initialize with an API key", async () => {
      const instance = new OpenPerplexityAI({ apiKey: "test_api_key" });
      expect(instance).toBeInstanceOf(OpenPerplexityAI);
  ...
  describe("chat", () => {
    ...
    describe("OpenPerplexityAI chat with callback and headers", () => {
