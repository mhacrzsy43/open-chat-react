...
import { OpenGoogleAI } from "./index";
...
let instance: OpenGoogleAI;

beforeEach(() => {
  instance = new OpenGoogleAI({ apiKey: "test" });
...
describe("OpenGoogleAI", () => {
  describe("init", () => {
    it("should correctly initialize with an API key", async () => {
      const instance = new OpenGoogleAI({ apiKey: "test_api_key" });
      expect(instance).toBeInstanceOf(OpenGoogleAI);
  ...
  describe("private method", () => {
    ...
    describe("buildGoogleMessages", () => {
      it("should use default text model when no images are included in messages", () => {
        ...
        const { contents, model: usedModel } = instance["buildGoogleMessages"](
          messages,
          model
        );
