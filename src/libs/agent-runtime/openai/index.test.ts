...
import { OpenOpenAI } from "./index";

// Mock the console.error to avoid polluting test output
vi.spyOn(console, "error").mockImplementation(() => {});

describe("OpenOpenAI", () => {
  let instance: OpenOpenAI;

  beforeEach(() => {
    instance = new OpenOpenAI({ apiKey: "test" });
  ...
  describe("init", () => {
    it("should correctly initialize with Azure options", () => {
      ...
      expect(client.baseURL).toEqual(
        baseURL + "/openai/deployments/" + modelName
      );
    });
    ...
    describe("initWithAzureOpenAI", () => {
      it("should correctly initialize with Azure options", () => {
        const baseURL = "https://abc.com";
        const modelName = "abc";
        const client = OpenOpenAI.initWithAzureOpenAI({
          apiKey: "test",
          useAzure: true,
          baseURL,
          azureOptions: {
  ...
  describe("chat", () => {
    ...
    describe("OpenOpenAI chat with callback and headers", () => {
