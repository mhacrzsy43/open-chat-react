...
import { OpenMoonshotAI } from "./index";
...
let instance: OpenMoonshotAI;

beforeEach(() => {
  instance = new OpenMoonshotAI({ apiKey: "test" });
...
describe("OpenMoonshotAI", () => {
  describe("init", () => {
    it("should correctly initialize with an API key", async () => {
      const instance = new OpenMoonshotAI({ apiKey: "test_api_key" });
      expect(instance).toBeInstanceOf(OpenMoonshotAI);
  ...
  describe("chat", () => {
    ...
    describe("OpenMoonshotAI chat with callback and headers", () => {
