...
import { OpenAnthropicAI } from "./index";
...
let instance: OpenAnthropicAI;

beforeEach(() => {
  instance = new OpenAnthropicAI({ apiKey: "test" });
...
describe("OpenAnthropicAI", () => {
  describe("init", () => {
    it("should correctly initialize with an API key", async () => {
      const instance = new OpenAnthropicAI({ apiKey: "test_api_key" });
      expect(instance).toBeInstanceOf(OpenAnthropicAI);
      expect(instance.baseURL).toBe("https://api.anthropic.com");
    });

    it("should correctly initialize with a baseURL", async () => {
      const instance = new OpenAnthropicAI({
        apiKey: "test_api_key",
