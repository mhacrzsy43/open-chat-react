...
export interface OpenBedrockAIParams {
  accessKeyId?: string;
  accessKeySecret?: string;
  region?: string;
}

export class OpenBedrockAI implements OpenRuntimeAI {
  private client: BedrockRuntimeClient;

  region: string;

  constructor({ region, accessKeyId, accessKeySecret }: OpenBedrockAIParams) {
