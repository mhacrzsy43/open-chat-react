...
const LogoThree = dynamic(() => import('@openhub/ui/es/LogoThree'));
const LogoSpline = dynamic(() => import('@openhub/ui/es/LogoThree/LogoSpline'));
  ...
  return (
    <>
      ...
      <div className={styles.title} style={{ fontSize: size.title }}>
        <strong style={mobile ? { fontSize: '1.2em' } : {}}>OpenChat</strong>
        {mobile ? <br /> : ' '}
        {t('slogan.title')}
      </div>
