...
describe("AgentRuntime", () => {
  describe("should initialize with various providers", () => {
    describe("OpenAI provider", () => {
      it("should initialize correctly", async () => {
        ...
        expect(runtime["_runtime"]).toBeInstanceOf(OpenOpenAI);
    ...
    describe("Azure OpenAI provider", () => {
      ...
      it("should initialize with azureOpenAIParams correctly", async () => {
        ...
        expect(runtime).toBeInstanceOf(AgentRuntime);
        const openAIRuntime = runtime["_runtime"] as OpenOpenAI;
        expect(openAIRuntime).toBeInstanceOf(OpenOpenAI);
      });
      ...
      it("should initialize with AzureAI correctly", async () => {
        ...
        expect(runtime["_runtime"]).toBeInstanceOf(OpenAzureOpenAI);
      });
    ...
    describe("ZhiPu AI provider", () => {
      it("should initialize correctly", async () => {
        ...
        // 假设 OpenZhipuAI 是 ZhiPu 提供者的实现类
        expect(runtime["_runtime"]).toBeInstanceOf(OpenZhipuAI);
      });
    ...
    describe("Google provider", () => {
      it("should initialize correctly", async () => {
        ...
        // 假设 OpenGoogleAI 是 Google 提供者的实现类
        expect(runtime["_runtime"]).toBeInstanceOf(OpenGoogleAI);
      });
    ...
    describe("Moonshot AI provider", () => {
      it("should initialize correctly", async () => {
        ...
        // 假设 OpenMoonshotAI 是 Moonshot 提供者的实现类
        expect(runtime["_runtime"]).toBeInstanceOf(OpenMoonshotAI);
      });
      it("should initialize correctly without apiKey", async () => {
        const jwtPayload: JWTPayload = {};
        const runtime = await AgentRuntime.initializeWithUserPayload(
    ...
    describe("Bedrock AI provider", () => {
      it("should initialize correctly with payload apiKey", async () => {
        ...
        // 假设 OpenBedrockAI 是 Bedrock 提供者的实现类
        expect(runtime["_runtime"]).toBeInstanceOf(OpenBedrockAI);
      });
    ...
    describe("Ollama provider", () => {
      it("should initialize correctly", async () => {
        ...
        // 假设 OpenOllamaAI 是 Ollama 提供者的实现类
        expect(runtime["_runtime"]).toBeInstanceOf(OpenOllamaAI);
      });
    ...
    describe("Perplexity AI provider", () => {
      it("should initialize correctly", async () => {
        ...
        // 假设 OpenPerplexityAI 是 Perplexity 提供者的实现类
        expect(runtime["_runtime"]).toBeInstanceOf(OpenPerplexityAI);
      });
    ...
    describe("Anthropic AI provider", () => {
      it("should initialize correctly", async () => {
        ...
        // 假设 OpenAnthropicAI 是 Anthropic 提供者的实现类
        expect(runtime["_runtime"]).toBeInstanceOf(OpenAnthropicAI);
      });
    ...
    describe("Mistral AI provider", () => {
      it("should initialize correctly", async () => {
        ...
        // 假设 OpenMistralAI 是 Mistral 提供者的实现类
        expect(runtime["_runtime"]).toBeInstanceOf(OpenMistralAI);
      });
    ...
    describe("OpenRouter AI provider", () => {
      it("should initialize correctly", async () => {
        ...
        // 假设 OpenOpenRouterAI 是 OpenRouter 提供者的实现类
        expect(runtime["_runtime"]).toBeInstanceOf(OpenOpenRouterAI);
      });
  ...
  describe("AgentRuntime chat method", () => {
    it("should run correctly", async () => {
      ...
      vi.spyOn(OpenOpenAI.prototype, "chat").mockResolvedValue(
        new Response("")
      );
    ...
    describe("callback", async () => {
      ...
      it("should call experimental_onToolCall correctly", async () => {
        // 使用 spyOn 模拟 chat 方法
        vi.spyOn(OpenOpenAI.prototype, "chat").mockImplementation(
