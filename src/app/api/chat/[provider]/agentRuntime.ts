...
class AgentRuntime {
  private _runtime: OpenRuntimeAI;

  constructor(runtime: OpenRuntimeAI) {
  ...
  static async initializeWithUserPayload(
    ...
    let runtimeModel: OpenRuntimeAI;
  ...
  private static initAzureOpenAI(payload: JWTPayload) {
    ...
    return new OpenAzureOpenAI(endpoint, apiKey, apiVersion);
  }
  ...
  private static async initZhipu(payload: JWTPayload) {
    ...
    return OpenZhipuAI.fromAPIKey({ apiKey });
  }
  ...
  private static initMoonshot(payload: JWTPayload) {
    ...
    return new OpenMoonshotAI({ apiKey, baseURL: MOONSHOT_PROXY_URL });
  }
  ...
  private static initGoogle(payload: JWTPayload) {
    ...
    return new OpenGoogleAI({ apiKey });
  }
  ...
  private static initBedrock(payload: JWTPayload) {
    ...
    return new OpenBedrockAI({ accessKeyId, accessKeySecret, region });
  }
  ...
  private static initOllama(payload: JWTPayload) {
    ...
    return new OpenOllamaAI({ baseURL });
  }
  ...
  private static initPerplexity(payload: JWTPayload) {
    ...
    return new OpenPerplexityAI({ apiKey });
  }
  ...
  private static initAnthropic(payload: JWTPayload) {
    ...
    return new OpenAnthropicAI({ apiKey, baseURL });
  }
  ...
  private static initMistral(payload: JWTPayload) {
    ...
    return new OpenMistralAI({ apiKey });
  }
  ...
  private static initOpenRouter(payload: JWTPayload) {
    ...
    return new OpenOpenRouterAI({ apiKey });
  }
}
