...
export class LocalDB extends Dexie {
  ...
  public users: OpenDBTable<"users">;
...
export type LocalDBSchema = {
  [t in keyof OpenDBSchemaMap]: {
    model: OpenDBSchemaMap[t];
    table: Dexie.Table<DBModel<OpenDBSchemaMap[t]>, string>;
  };
};
type OpenDBTable<T extends keyof OpenDBSchemaMap> = LocalDBSchema[T]["table"];
