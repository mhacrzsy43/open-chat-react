export default {
  ...
  response: {
    ...
    PluginOpenApiInitError:
      "很抱歉，OpenAPI 客户端初始化失败，请检查 OpenAPI 的配置信息是否正确",

    InvalidAccessCode:
      "密码不正确或为空，请输入正确的访问密码，或者添加自定义 API Key",
    ...
    InvalidZhipuAPIKey:
      "Zhipu API Key 不正确或为空，请检查 Zhipu API Key 后重试",

    MistralBizError: "请求 Mistral AI 服务出错，请根据以下信息排查或重试",
    InvalidMistralAPIKey:
      "Mistral AI API Key 不正确或为空，请检查 Mistral API Key 后重试",

    MoonshotBizError: "请求月之暗面服务出错，请根据以下信息排查或重试",
    InvalidMoonshotAPIKey:
      "Moonshot AI API Key 不正确或为空，请检查 Moonshot API Key 后重试",

    GoogleBizError: "请求 Google 服务出错，请根据以下信息排查或重试",
    InvalidGoogleAPIKey:
      "Google API Key 不正确或为空，请检查 Google API Key 后重试",

    InvalidBedrockCredentials:
      "Bedrock 鉴权未通过，请检查 AccessKeyId/SecretAccessKey 后重试",
    BedrockBizError: "请求 Bedrock 服务出错，请根据以下信息排查或重试",

    InvalidAzureAPIKey:
      "Azure API Key 不正确或为空，请检查 Azure API Key 后重试",
    AzureBizError: "请求 Azure AI 服务出错，请根据以下信息排查或重试",

    InvalidPerplexityAPIKey:
      "Perplexity API Key 不正确或为空，请检查 Perplexity API Key 后重试",
    PerplexityBizError: "请求 Perplexity AI 服务出错，请根据以下信息排查或重试",

    InvalidAnthropicAPIKey:
      "Anthropic API Key 不正确或为空，请检查 Anthropic API Key 后重试",
    ...
    InvalidOpenRouterAPIKey:
      "OpenRouter API Key 不正确或为空，请检查 OpenRouter API Key 后重试",
    ...
    AgentRuntimeError: "Open 语言模型运行时执行出错，请根据以下信息排查或重试",
    /* eslint-enable */
  },
  stt: {
  ...
  unlock: {
    apikey: {
      Anthropic: {
        description:
          "输入你的 Anthropic API Key 即可开始会话。应用不会记录你的 API Key",
      ...
      Google: {
        description:
          "输入你的 Google API Key 即可开始会话。应用不会记录你的 API Key",
        title: "使用自定义 Google API Key",
      },
      Groq: {
        description:
          "输入你的 Groq API Key 即可开始会话。应用不会记录你的 API Key",
        title: "使用自定义 Groq API Key",
      },
      Mistral: {
        description:
          "输入你的 Mistral AI API Key 即可开始会话。应用不会记录你的 API Key",
        title: "使用自定义 Mistral AI API Key",
      },
      Moonshot: {
        description:
          "输入你的 Moonshot AI API Key 即可开始会话。应用不会记录你的 API Key",
        title: "使用自定义 Moonshot AI API Key",
      },
      OpenAI: {
        addProxyUrl: "添加 OpenAI 代理地址（可选）",
        description:
          "输入你的 OpenAI API Key 即可开始会话。应用不会记录你的 API Key",
        title: "使用自定义 OpenAI API Key",
      },
      OpenRouter: {
        description:
          "输入你的 OpenRouter API Key 即可开始会话。应用不会记录你的 API Key",
        title: "使用自定义 OpenRouter API Key",
      },
      Perplexity: {
        description:
          "输入你的 Perplexity API Key 即可开始会话。应用不会记录你的 API Key",
        title: "使用自定义 Perplexity API Key",
      },
      Zhipu: {
        description:
          "输入你的 Zhipu API Key 即可开始会话。应用不会记录你的 API Key",
    ...
    password: {
      description:
        "管理员已开启应用加密，输入应用密码后即可解锁应用。密码只需填写一次",
      placeholder: "请输入密码",
      title: "输入密码解锁应用",
    },
    tabs: {
