...
import { OpenAgentConfig, OpenAgentTTSConfig } from "@/types/agent";
import {
  GlobalBaseSettings,
  GlobalDefaultAgent,
  GlobalLLMConfig,
...
export const DEFAUTT_AGENT_TTS_CONFIG: OpenAgentTTSConfig = {
...
export const DEFAULT_AGENT_CONFIG: OpenAgentConfig = {
