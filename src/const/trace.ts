export const LOBE_CHAT_TRACE_HEADER = 'X-open-trace';
export const LOBE_CHAT_TRACE_ID = 'X-open-chat-trace-id';
export const LOBE_CHAT_OBSERVATION_ID = 'X-open-observation-id';
