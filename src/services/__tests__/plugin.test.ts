...
describe("PluginService", () => {
  describe("getPluginList", () => {
    ...
    it("should handle fetch error", async () => {
      ...
      // Act & Assert
      await expect(pluginService.getPluginList()).rejects.toThrow(
        "Network error"
      );
    });
  });
    ...
    it("should install a plugin", async () => {
      ...
      const fakePlugin = {
        ...
        manifest: {
          name: "TestPlugin",
          version: "1.0.0",
        } as unknown as OpenChatPluginManifest,
        type: "plugin",
  ...
  describe("updatePlugin", () => {
    it("should update a plugin", async () => {
      ...
      const value = {
        settings: { ab: "1" },
      } as unknown as OpenToolCustomPlugin;
  ...
  it("can parse the OpenAI plugin", async () => {
    const manifest = pluginService["convertOpenAIManifestToOpenManifest"](
      OpenAIPlugin as any
    );
