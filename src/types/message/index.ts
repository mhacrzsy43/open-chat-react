import { IPluginErrorType } from "@open/chat-plugin-sdk";

import { IOpenAgentRuntimeErrorType } from "@/libs/agent-runtime";
...
export interface ChatMessageError {
  body?: any;
  message: string;
  type: ErrorType | IPluginErrorType | IOpenAgentRuntimeErrorType;
}
