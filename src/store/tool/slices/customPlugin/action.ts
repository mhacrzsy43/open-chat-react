...
import { OpenToolCustomPlugin, PluginInstallError } from "@/types/tool/plugin";
...
export interface CustomPluginAction {
  installCustomPlugin: (value: OpenToolCustomPlugin) => Promise<void>;
  ...
  updateNewCustomPlugin: (value: Partial<OpenToolCustomPlugin>) => void;
}
