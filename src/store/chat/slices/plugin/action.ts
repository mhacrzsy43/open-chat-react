import { PluginErrorType } from '@open/chat-plugin-sdk';
...
> = (set, get) => ({
  ...
  triggerFunctionCall: async (id) => {
    ...
    if (message.content) {
      ...
      // fix https://github.com/openhub/open-chat/issues/1094, remove and retry after experiencing plugin illusion
      if (!apiName) {
