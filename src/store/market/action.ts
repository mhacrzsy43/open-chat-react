...
import { AgentsMarketItem, OpenChatAgentsMarketIndex } from '@/types/market';
...
export interface StoreAction {
  ...
  useFetchAgentList: () => SWRResponse<OpenChatAgentsMarketIndex>;
}
...
> = (set, get) => ({
  ...
  useFetchAgentList: () =>
    useSWR<OpenChatAgentsMarketIndex>(
