import { Alert, Icon, Modal, Tooltip } from "@openhub/ui";
...
interface DevModalProps {
  ...
  onSave?: (value: OpenToolCustomPlugin) => Promise<void> | void;
  onValueChange?: (value: Partial<OpenToolCustomPlugin>) => void;
  open?: boolean;
  value?: OpenToolCustomPlugin;
}
      ...
      <Form.Provider
        ...
        onFormFinish={async (_, info) => {
          if (onSave) {
            ...
            await onSave?.(info.values as OpenToolCustomPlugin);
            setSubmitting(false);
          }
          message.success(
