import { Form, FormItemProps, Input, TextArea } from "@openhub/ui";
...
const EmojiPicker = dynamic(() => import("@openhub/ui/es/EmojiPicker"), {
  ssr: false,
});

const LocalForm = memo<{ form: FormInstance; mode?: "edit" | "create" }>(
  ({ form, mode }) => {
    ...
    const metaItem: FormItemProps[] = [
      ...
      {
        children: (
          <TextArea placeholder={t("dev.meta.description.placeholder")} />
        ),
      ...
      {
        children: <Input placeholder={"OpenHub"} />,
        desc: t("dev.meta.author.desc"),
        label: t("dev.meta.author.label"),
        name: ["manifest", "author"],
      },
      {
        children: <Input placeholder={"https://www.openhub.com"} />,
